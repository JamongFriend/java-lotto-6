...
public class Phrases {
    public static final String purchaseAmountPhrase = "구입 금액을 입력해 주세요.";
    public static final String purchaseCountPhrase = "개를 구매했습니다.";
    public static final String winningNumPhrase = "당첨 번호를 입력해 주세요.";
    public static final String bonusNumPharse = "보너스 번호를 입력해 주세요.";
    public static final String statisticsPharse = "당첨 통계";
